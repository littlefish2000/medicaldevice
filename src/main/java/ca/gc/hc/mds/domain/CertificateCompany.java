...
public class CertificateCompany {
    ...
    public static TypedQuery<CertificateCompany> findCertificateCompanysByCompanyIdEquals(BigDecimal companyId) {
        if (companyId == null) throw new IllegalArgumentException("The entryDate argument is required");
        EntityManager em = CertificateCompany.entityManager();
        TypedQuery<CertificateCompany> q = em.createQuery("SELECT o FROM CertificateCompany AS o WHERE o.id.companyId = :companyId", CertificateCompany.class);
